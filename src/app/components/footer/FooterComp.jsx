...
export default function FooterComp() {
  ...
  return (
    <motion.footer
      className={
        'flex items-center relative justify-center flex-col bg-violet-900 mt-32 pt-16 w-full top-0 h-fit p-14 ' +
        styles.res_footer
      }
      initial="hidden"
      animate="visible"
    ...
    >
      ...
      <motion.section
        className={
          'flex items-center justify-between disabled: bg-violet-800 w-4/5 p-8 z-20 rounded-2xl shadow-lg absolute top-20 ' +
          styles.res_float
        }
      ...
      <motion.section
        className={'flex items-start justify-center gap-52 border-b-2 border-gray-500 pb-5 ' + styles.res_footer}
        variants={sectionVariants}
      >

    ...
    <section className="flex flex-col items-center bg-opacity-50 bg-gray-700 w-full pt-5 pb-5 mt-5">
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-evenly">
        ...
        <p className="bg-opac w-3/6 shadow-md bg-opacity-80 bg-fuchsia-950 text-xl  px-5 pt-5 p-2 ">
          ...
          tajribasiga ega bo‘lgan o‘qituvchidir. Temurbek Shakhobov  <b>Umumiy Ingliz tili, CEFR, Multilevel testlar, IELTS, TKT va ESOL</b> bo‘yicha 
          dars berib keladi. Ustozning rahbarligi ostida talabalar doimiy ravishda yuqori natijalarga erishib, Umumiy Ingliz tili va CEFR 
          bo‘yicha C1 darajasiga erishdilar, shuningdek, 20 dan ortiq talabalar 7.0 va undan yuqori IELTS ballarini olishgan. 

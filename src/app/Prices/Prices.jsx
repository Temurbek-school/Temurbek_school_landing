...
export default function Prices() {
    return (
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-5 sm:mt-10 text-white'>
            ...
            <div className='bg-neutral-800 px-4 sm:px-6 lg:px-10 py-4 sm:py-5 lg:py-8 rounded-3xl max-w-full sm:max-w-sm lg:max-w-lg mx-auto lg:mx-4'>
                <span className='bg-green-500 p-4 rounded-xl'>GENERAL ENGLISH</span>
            ...
            <div className='bg-blue-900 px-4 sm:px-6 lg:px-10 py-4 sm:py-5 lg:py-8 rounded-3xl max-w-full sm:max-w-sm lg:max-w-lg mx-auto lg:mx-4'>
            ...
            <div className='bg-teal-700 px-4 sm:px-6 lg:px-10 py-4 sm:py-5 lg:py-8 rounded-3xl max-w-full sm:max-w-sm lg:max-w-lg mx-auto lg:mx-4'>
                <span className='bg-green-600 p-3 rounded-xl'>Rus tili</span>
            ...
            <div className='bg-slate-700 px-4 sm:px-6 lg:px-10 py-4 sm:py-5 lg:py-8 rounded-3xl max-w-full sm:max-w-sm lg:max-w-lg mx-auto lg:mx-4'>
